		...
		<div class="row">
			<div class="col-md-2">
				<div class="col-md-8 p-4 mb-4" id="form">
					...
					<div class="row mb-4 ps-5 justify-content-center">
						<form class="row" action="/VendreUnArticle" method="post">
							<div class="col-md-3 p-3 mb-3">
								<div class="input-group mb-3">
									<label for="idarticle">Article </label>
								</div>
							</div>
							<div class="col-md-7 p-3 mb-3">
								<div class="input-group mb-3">
									<input type="text" class="form-control" id="idarticle"
										name="sarticle" value="${empty sarticle? '':sarticle}">
								</div>
							...
							<div class="col-md-7 p-3 mb-3">
								<div class="input-group mb-3">
									<input type="file" class="form-control" id="idphoto"
							...
							<div class="col-md-7 p-1 mb-1">
								<div class="input-group mb-3">
									<input type="date" class="form-control" id="iddebutenchere"
										name="sdate_debut"
										value="${empty sdate_debut? '':sdate_debut}"> <input
										type="time" class="form-control" id="iddebutenchere"
										name="sheure_debut"
										value="${empty sheure_debut? '':sheure_debut}">
								</div>
							</div>
							coucou2
							<div class="col-md-3 p-1 mb-1">
									...
									<div class="col-md-7 p-1 mb-1">
										<div class="input-group mb-3">
											<c:if test="${empty scode_postal}">
												<input type="number" class="form-control" id="idcodepostal"
													name="scode_postal"
													value="${sessionScope.myUser.codePostal}">
											</c:if>
											<c:if test="${!empty scode_postal}">
												<input type="number" class="form-control" id="idcodepostal"
													name="scode_postal"
													value="${empty scode_postal? '':scode_postal}">
											</c:if>
										</div>
									</div>
									<div class="col-md-3 p-1 mb-1">
							...
							<div class="row p-4 mb-2 justify-content-center">
								...
								<div class="col-md-2 text-center">
									<a href=""> <input class="btn btn-danger ms-2"
