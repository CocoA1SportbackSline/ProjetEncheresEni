	...
	<div class="container-fluid" id="bg" style="padding: 5% 13%">
		<div class="row" id="form">
			<div class="col-md-3 m-2 p-4">
				<img
					src="<c:url value="public/imageArticle/${empty article.article.image ? 'image-not-found.png' : article.article.image}"></c:url>"
					...
					<div style="padding-left: 10%">
						<c:if test="${checkDateFin}">
							<c:if test="${!empty article.userEncher}">
								<c:if
									test="${article.userEncher.pseudo == sessionScope.myUser.pseudo}">
									<div class="row">
						...
						<div class="row">
							...
							<div class="col-8">
								<p>${empty article.meilleurEnchere ? '0' : article.meilleurEnchere.montant_enchere}
									points ${!empty article.userEncher ? article.userEncher.pseudo : ''}</p>
							</div>
						</div>
						<div class="row">
							<div class="col-4">
						...
						<div class="row">
							...
							<div class="col-8">
								<p>
									<a href="./Profil?sid=${article.user.no_utlisateur}">${article.user.pseudo}</a>
								</p>
							</div>
						</div>
										...
										<div class="row">
											...
											<div class="col-4">
												<input class="form-control" type="number"
													id="idMaProposition" name="smonEnchere"
											...
											<div class="col-4">
												<button class="btn me-2" id="btn-vert" name="idNo_article"
													value="${sno_article}" type="submit">Enchérir</button>
											</div>
										</div>
									</form>
								</c:if>
								...
								<form action="./ModifierVente" method="post">
									<div class="row">
										<div class="col-8 offset-4">
											<button class="btn me-2" id="btn-vert" name="idNo_article"
												value="${sno_article}" type="submit">Modifier Vente</button>
										</div>
									</div>
								</form>
							</c:if>
