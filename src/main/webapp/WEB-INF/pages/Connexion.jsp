		...
		<div class="l">
			<div class="col-3 col-md-3 col-sm-10  mx-auto text-center">
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="pseudoform" placeholder="Votre pseudo" name="pseudoform" required>
				</div>
				<div class="mb-3">
					<label for="passwordform" class="form-label">Mot de passe</label> 
					<input type="password" class="form-control" id="passwordform" placeholder="Votre mot de passe" name="passwordform" required>
				</div>
			</div>
