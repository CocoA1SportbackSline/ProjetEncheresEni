...
<main>
	...
	<form action="<%=request.getContextPath()%>/MonProfil" method="post">
		<div class="row my-2">
			...
			<div class="col-4">
				<input class="form-control" type="text" id="idPseudo" name="spseudo"
					value="${ myUser.pseudo }">
			</div>
			<div class="col-2">
			...
			<div class="col-4">
				<input class="form-control" type="text" id="idNom" name="snom"
					value="${ myUser.nom }">
			</div>
		</div>
		...
		<div class="row my-2">
			...
			<div class="col-4">
				<input class="form-control" type="text" id="idPrenom" name="sprenom"
					value="${ myUser.prenom }">
			</div>
			<div class="col-2">
			...
			<div class="col-4">
				<input class="form-control" type="text" id="idemail" name="semail"
					value="${ myUser.email }">
			</div>
		</div>
		...
		<div class="row my-2">
			...
			<div class="col-4">
				<input class="form-control" type="text" id="idtelephone"
			...
			<div class="col-4">
				<input class="form-control" type="text" id="idrue" name="srue"
					value="${ myUser.rue }">
			</div>
		</div>
		...
		<div class="row my-2">
			...
			<div class="col-4">
				<input class="form-control" type="text" id="idcodepostal"
			...
			<div class="col-4">
				<input class="form-control" type="text" id="idville" name="sville"
					value="${ myUser.ville }">
			</div>
		</div>
		...
		<div class="row my-2">
			...
			<div class="col-4">
				<input class="form-control" type="password" id="idmdpact"
					name="spasswordact">
			</div>
		</div>
		...
		<div class="row my-2">
			...
			<div class="col-4">
				<input class="form-control" type="password" id="idmdpnouv"
					name="spasswordnew">
			</div>
			<div class="col-2">
			...
			<div class="col-4">
				<input class="form-control" type="password" id="idmdpconf"
					name="spasswordconf">
			</div>
		</div>
